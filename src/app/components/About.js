...
import { FaCheckCircle, FaUsers, FaTrophy, FaShippingFast } from 'react-icons/fa'
    ...
    <div className="min-h-screen pt-16 md:pt-[calc(4rem+32px)]">
      ...
      <div className="relative h-[400px] md:h-[500px]">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-[#D6E752] mb-4">Our Story</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Crafting quality fashion since 2015, we ve been dedicated to bringing you the finest clothing with style and comfort.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">
              At Oxtoyin, our mission is to revolutionize the fashion industry by providing high-quality, 
              sustainable clothing that empowers individuals to express their unique style while maintaining 
              our commitment to environmental responsibility and ethical manufacturing practices.
            </p>
      ...
      <div className="bg-white/95 backdrop-blur-sm py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-black text-center mb-12">Our Leadership</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((member) => (
